	...
	methods: {
		...
		async doUpload(files, zipName, startTime) {
			...
			if (success) {
				...
				if (this.updates.firmware || this.updates.wifiServer || this.updates.wifiServerSpiffs || this.updates.display || this.updates.usb) {
